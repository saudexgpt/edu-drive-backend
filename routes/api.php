...
use App\Http\Controllers\Interview\InterviewsController;
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::group(['prefix' => 'interview'], function () {
        Route::get('quiz', [InterviewsController::class, 'quiz']);
        Route::get('quiz-dashboard', [InterviewsController::class, 'quizDashboard']);
        Route::get('fetch-questions-bank', [InterviewsController::class, 'fetchQuestionBank']);
        Route::get('fetch-compiled-tests', [InterviewsController::class, 'fetchCompiledQuizzes']);

        Route::get('staff-interviews', [InterviewsController::class, 'staffInterviews']);

        Route::post('store-question', [InterviewsController::class, 'storeQuestion']);
        Route::put('update-question/{id}', [InterviewsController::class, 'updateQuestion']);
        Route::post('set-quiz', [InterviewsController::class, 'setQuiz']);
        Route::put('update-quiz/{id}', [InterviewsController::class, 'updateQuiz']);
        Route::put('activate-quiz/{id}', [InterviewsController::class, 'activateQuiz']);

        Route::delete('delete-quiz/{id}', [InterviewsController::class, 'deleteQuiz']);
        Route::post('attempt-quiz', [InterviewsController::class, 'attemptQuiz']);
        Route::post('update-remaining-time', [InterviewsController::class, 'updateRemainingTime']);
        Route::post('submit-quiz-answers', [InterviewsController::class, 'submitQuizAnswers']);
        Route::post('score-theory-answers', [InterviewsController::class, 'scoreTheoryAnswers']);
    ...
    Route::group(['prefix' => 'result'], function () {
        ...
        Route::get('cummulative-class-broadsheet', [ResultsController::class, 'cummulativeClassBroadSheet']);
