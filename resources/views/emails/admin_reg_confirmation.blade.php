...
<head>
  ...
  <title>New email template 2020-03-11</title>
  <!--[if (mso 16)]>
    <style type="text/css">
      ...
      <tr style="border-collapse:collapse;">
        <td valign="top" style="padding:0;Margin:0;">
          ...
          <table class="es-header" cellspacing="0" cellpadding="0" align="center"
            ...
            <tr style="border-collapse:collapse;">
              <td style="padding:0;Margin:0;background-color:#182886;" bgcolor="#182886" align="center">
                <table class="es-header-body" width="600" cellspacing="0" cellpadding="0" align="center"
                  ...
                  <tr style="border-collapse:collapse;">
                    <td
                      style="Margin:0;padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;background-color:transparent;"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr style="border-collapse:collapse;">
                                <td style="padding:0;Margin:0;font-size:0px;" align="center">
                                  <img class="adapt-img" src="{{ url('img/96711583935047355.png') }}" alt
          ...
          <table class="es-content" cellspacing="0" cellpadding="0" align="center"
            ...
            <tr style="border-collapse:collapse;">
              <td
                style="padding:0;Margin:0;background-image:url(img/35761583935307627.png);background-repeat:no-repeat;background-position:center top;"
                background="img/35761583935307627.png" align="center">
                <table class="es-content-body"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;"
                  width="600" cellspacing="0" cellpadding="0" align="center">
                  <tr style="border-collapse:collapse;">
                              ...
                              <tr style="border-collapse:collapse;">
                                <td class="es-m-txt-l" bgcolor="transparent" align="left"
                                  ...
                                  <p
                                    ...
                                    <br>We're excited to inform you that the registration of {{ $user->school_name }} on
                                    Edu-Drive Management System is successful. Below is your login credentials.
                                  </p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse;">
                                <td class="es-m-txt-l" bgcolor="#767b76" align="left"
                                  ...
                                  <p
                                    ...
                                    Url: <a
                                      href="https://portal.edu-drive.com">https://portal.edu-drive.com</a><br>Username:
                                    {{ $user->username }}<br>Password: {{ $user->raw_password }}</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse;">
                                <td class="es-m-txt-l" align="left"
                                  ...
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                    Kindly activate your account by clicking the link below:</p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse;">
                                <td class="es-m-txt-l" align="left"
                                  style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;"><a
                                    target="_blank" href="{{ route('confirm_admin_reg', $user->confirm_hash) }}"
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;text-decoration:underline;color:#3D9F2C;">Activate</a>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse;">
                                <td class="es-m-txt-l" align="left"
                        ...
                        <tr style="border-collapse:collapse;">
                          <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                            <table
                              ...
                              width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffecd1" role="presentation">
                              <tr style="border-collapse:collapse;">
                                  ...
                                  <table class="es-table-not-adapt es-social" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr style="border-collapse:collapse;">
                                      <td valign="top" align="center"
                                        style="padding:0;Margin:0;padding-right:10px;"><img title="Facebook"
                                          src="img/facebook-circle-colored.png" alt="Fb" width="32"
                                          height="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;">
                                      </td>
                                      <td valign="top" align="center"
                                        style="padding:0;Margin:0;padding-right:10px;"><img title="Twitter"
                                          src="img/twitter-circle-colored.png" alt="Tw" width="32"
                                          height="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;">
                                      </td>
                                      <td valign="top" align="center"
                                        style="padding:0;Margin:0;padding-right:10px;"><img title="Instagram"
                                          src="img/instagram-circle-colored.png" alt="Inst" width="32"
                                          height="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;">
                                      </td>
                                      <td valign="top" align="center" style="padding:0;Margin:0;"><img
                                          title="Youtube" src="img/youtube-circle-colored.png" alt="Yt"
                                          width="32" height="32"
                                          style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;">
                                      </td>
                                    </tr>
                          ...
                          <td width="540" valign="top" align="center" style="padding:0;Margin:0;">
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr style="border-collapse:collapse;">
                                <td align="left" style="padding:0;Margin:0;">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#E06666;">
                                    You received this email because you just signed up for a new account. Kindly ignore
                                    if you did not register.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
            ...
            <tr style="border-collapse:collapse;">
              <td style="padding:0;Margin:0;background-color:#182886;" bgcolor="#182886" align="center">
                <table class="es-footer-body"
                  style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#425495;"
                  width="600" cellspacing="0" cellpadding="0" bgcolor="#425495" align="center">
                  <tr style="border-collapse:collapse;">
                    <td align="left"
                        ...
                        <tr style="border-collapse:collapse;">
                          <td width="540" valign="top" align="center" style="padding:0;Margin:0;">
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                              <tr style="border-collapse:collapse;">
                                <td style="padding:0;Margin:0;font-size:0px;" align="center"><img class="adapt-img"
                                    src="img/37921583935268937.png" alt
                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;"
                                    width="75" height="62"></td>
                              </tr>
                              <tr style="border-collapse:collapse;">
                                <td align="center" style="padding:0;Margin:0;">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#FFFFFF;">
                                    Edu-Drive Management Software is powered by<br>Klex Global Resources Limited<br></p>
                                </td>
                              </tr>
                            </table>
                          </td>
